"""Train the full static DQN baseline on the GridUAVEnv environment."""
...
TENSORBOARD_RUN_NAME = "dqn_static_full"


def main() -> None:
    """Run full static DQN baseline training."""
    ...
    print("Static DQN baseline training complete.")
